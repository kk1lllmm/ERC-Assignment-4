...
def is_within_acceptance(puck_coords, target, acceptance_percent=5):
  #complete the function
  acceptance_range=target*(int)(acceptance_percent/100)
  return abs((int)(target)-(int)(puck_coords[0])<=acceptance_range or (int)(target)-(int)(puck_coords[1])<=acceptance_range)
